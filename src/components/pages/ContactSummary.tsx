...
export function ContactSummary() {
  ...
  // Mock summary content based on contact type
  const getSummaryContent = () => {
    if (contact.type === 'contact') {
      return `## Who is ${contact.name}?

${contact.name} is a VIP customer who has been with your organization for **2 years and 4 months**. They are the primary contact for several high-value projects and typically communicates via ${contact.channel || 'multiple channels'}.
...
- **Preferred Communication**: ${contact.channel ? contact.channel.charAt(0).toUpperCase() + contact.channel.slice(1) : 'Email'}

### Recent Context

Your last conversation with ${contact.name} was about a **payment issue with order #45234**. They were experiencing a delayed refund and expressed frustration about the timeline. The issue is still in progress and requires follow-up.
...
- **Personal Touch**: Congratulate them on their company's recent Series B funding announcement`;
      ...
      return `## About ${contact.name}

${contact.name} is an **enterprise client** that has been partnering with your organization since **March 2023**. They are in the technology sector with approximately 250 employees.
...
Your team has had **12 conversations** with ${contact.name} in the last 30 days, primarily focused on technical implementation and feature requests. Their engagement level is high, which is a positive indicator for renewal.
...
${contact.name} is currently in a growth phase and has expressed interest in scaling their usage of your platform. They're evaluating competitors but have shown strong satisfaction with your support team.
...
- **Relationship Building**: Invite key stakeholders to your upcoming customer advisory board meeting`;
      ...
      return `## About the "${contact.name}" Tag
...
- **Most Active Channel**: ${contact.channel || 'Multiple channels'}
- **Average Response Time**: 4.2 hours

### Common Themes

Conversations tagged with "${contact.name}" typically involve:
...
- **Follow-up**: Check on the 3 conversations that were resolved but haven't received follow-up confirmation`;
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      const mockResponse = `Based on ${contact.name}'s communication history, I can help with that. What specific aspect would you like to explore?`;
    ...
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="h-14 border-b border-border flex items-center justify-between px-6 flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <ContactIcon className="size-5" style={channelColor ? { color: channelColor } : undefined} />
          <div>
        ...
        <div className="max-w-4xl mx-auto p-6 space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  AI-generated insights about {contact.name} and your relationship
                </p>
            ...
            <div className="pt-4 border-t border-border">
              <div className="flex items-center gap-6 text-sm text-muted-foreground">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Last viewed {new Date(contact.lastViewed).toLocaleString('en-US', { 
                    month: 'short', 
                    day: 'numeric',
                    hour: 'numeric',
                    minute: '2-digit'
          ...
          <div className="bg-card border border-border rounded-lg p-6 space-y-4">
            <div className="flex items-center gap-2 mb-4">
              <Sparkles className="size-5" style={{ color: 'hsl(var(--ai))' }} />
              <h3 className="font-semibold">Ask Wanda about {contact.name}</h3>
            </div>
            ...
            <div className="flex gap-2">
              <input
                ...
                placeholder={`Ask about ${contact.name}'s history, preferences, or next steps...`}
